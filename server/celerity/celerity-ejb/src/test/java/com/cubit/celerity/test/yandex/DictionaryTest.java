package com.cubit.celerity.test.yandex;
...
import com.cubit.celerity.util.yandex.YandexCallback;
import com.cubit.celerity.util.yandex.YandexDictionary;
import com.cubit.celerity.util.yandex.YandexUtil;
...
public class DictionaryTest {
    ...
    public void testLookupHumanize() throws Exception {
        ...
        Assert.assertTrue(translatedWord.getDefinitions().size() == 4);
